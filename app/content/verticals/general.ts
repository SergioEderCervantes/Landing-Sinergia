...
export const generalContent: VerticalContent = {
  hero: {
    ...
    title: 'Consigue un flujo predecible de citas calificadas, sin perseguir leads ni vivir pegado al celular.',
    titleHighlight: 'predecible',
    subtitle: 'Instalamos un sistema de ventas que atrae a tu cliente ideal, filtra a los curiosos y agenda automáticamente solo a quienes están listos para comprar.',
  ...
  contactForm: {
    ...
    successMessage: 'Gracias por tu interés. Revisaremos tu información y nos pondremos en contacto contigo lo antes posible.',
