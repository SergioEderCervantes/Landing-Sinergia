...
import { CASOS } from '@/app/content/cases'
...
export const mockContent: VerticalContent = {
  ...
  contactForm: {
    ...
    successMessage: 'Lorem ipsum dolor sit amet. Consectetur adipiscing elit y nos pondremos en contacto.',
    successReturnText: 'Volver al mock',
    successReturnHref: '/mock',
    steps: [
      { id: 'name', label: '¿Lorem ipsum llamas?', placeholder: 'Tu nombre lorem', type: 'text' },
      { id: 'email', label: '¿A qué correo lorem?', placeholder: 'lorem@ipsum.com', type: 'email' },
      { id: 'brand', label: '¿Cómo se llama tu lorem?', placeholder: 'Nombre de tu lorem', type: 'text' },
      { id: 'brand_story', label: 'Cuéntanos sobre tu lorem ipsum', placeholder: '¿Qué lorem y qué ipsum lograr?', type: 'textarea' },
      { id: 'website', label: '¿Tienes website lorem?', placeholder: 'url o @lorem', type: 'text' },
      { id: 'budget', label: '¿Con cuanto lorem cuentas?', placeholder: '$9999 LOREM', type: 'text' },
      { id: 'source', label: '¿Cómo nos lorem encontraste?', placeholder: 'Selecciona lorem', type: 'select' },
    ],
  },
}
